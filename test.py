    ...
    with torch.no_grad():
        for it, (images_vis, images_ir,name) in enumerate(test_loader):
            ...
            for k in range(len(name)):
                ...
                total = sum(p.numel() for p in fusionmodel.parameters())
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run FAFusiuon with pytorch')
    parser.add_argument('--model_name', '-M', type=str, default='FAFusion')
